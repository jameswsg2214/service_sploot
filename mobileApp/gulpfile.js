...
gulp.task('buildbin', () => {
    return gulp.src(['bin/**'])
        .pipe(uglify())
        .pipe(gulp.dest('../../../release/tmp/mobileApp/bin'))
});

gulp.task('buildmain', () => {
    return gulp.src(['index.js'])
        .pipe(uglify())
        .pipe(gulp.dest('../../../release/tmp/mobileApp/'))
});
...
gulp.task('buildsrc', () => {
    return gulp.src(['src/**/*.js'])
        .pipe(uglify())
        .pipe(gulp.dest('../../../release/tmp/mobileApp/src'))
});
...
gulp.task('buildzip', () => {
    ...
    return gulp.src(['../../../release/tmp/**'])
        .pipe(zip('oasys_mobileApp' + pkg.version + '.zip'))
